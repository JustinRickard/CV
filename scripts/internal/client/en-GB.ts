...
class en_gb implements IUiText {
	...
	Tabs_Home: string = "About me";
	Tabs_Jobs: string = "Jobs";
	Tabs_Assessments: string = "Assessments";
	Tabs_LiveChat: string = "Live Chat";
	Tabs_Programming: string = "Programming";
	...
	ProgrammingCSharp_Title: string = "C#";
