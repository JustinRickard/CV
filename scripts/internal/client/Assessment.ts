...
class Assessment implements IAssessment {
	...
	constructor(id: number, assessmentType: AssessmentType, name: string, caseStudies: ICaseStudy[], errorHandler: IErrorHandler) {
		var utils = new Utilities(errorHandler);
		this.ID = id;
		this.AssessmentType = assessmentType;
		this.Name = name;

		this.CaseStudies = new Array<CaseStudy>();
		caseStudies.forEach((x) => { this.CaseStudies.push(utils.CreateCaseStudy(x)) });
